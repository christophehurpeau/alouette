...
export declare const createAlouetteTokens: <const ColorScales extends AlouetteColorScales>(colorScales: ColorScales, { spacing }?: AlouetteTokensOptions) => {
    color: { [Key in "black" | "white" | keyof ColorScaleTokens<ColorScales> extends number ? `${number & keyof ColorScaleTokens<ColorScales>}` : "black" | "white" | keyof ColorScaleTokens<ColorScales>]: import("@tamagui/core").Variable<string>; };
    space: {
    ...
    readonly color: { [Key_1 in "black" | "white" | keyof ColorScaleTokens<ColorScales> extends number ? `${number & keyof ColorScaleTokens<ColorScales>}` : "black" | "white" | keyof ColorScaleTokens<ColorScales>]: import("@tamagui/core").Variable<({
