...
export declare const createAlouetteThemes: <const ColorScales extends AlouetteColorScales>(tokens: ReturnType<typeof createAlouetteTokens<ColorScales>>, customCreateColorTheme?: <const ColorTheme extends keyof AlouetteThemeNames>(tokens: ReturnType<typeof createAlouetteTokens<AlouetteColorScales>>, themeName: ColorTheme, mode?: "dark" | "light", backgroundColor?: Variable<string>, textColor?: Variable<string>) => {
    screenBackgroundColor: Variable<string>;
    "screenBackgroundColor.elevated": Variable<string>;
    "screenBackgroundColor.translucent": Variable<string>;
    nonInteractiveBackgroundColor: Variable<string>;
