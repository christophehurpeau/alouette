...
export declare const createColorTheme: <const ColorScales extends AlouetteColorScales>(tokens: ReturnType<typeof createAlouetteTokens<ColorScales>>, colorScaleName: string & keyof ColorScales, mode?: "dark" | "light", backgroundColor?: Variable<string>, textColor?: Variable<string>, contrastTextColor?: Variable<string>) => {
    backgroundColor: Variable<string>;
    textColor: Variable<string>;
    mainColor: { [Key in "black" | "white" | "disabled" | "contrastDisabled" | keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; } extends number ? `${number & keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; }}` : "black" | "white" | "disabled" | "contrastDisabled" | keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; }]: Variable<string>; }["black" | "white" | "disabled" | "contrastDisabled" | keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; } extends number ? `${number & keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; }}` : "black" | "white" | "disabled" | "contrastDisabled" | keyof { [K in string & keyof ColorScales as `${K}.1` | `${K}.4` | `${K}.2` | `${K}.3` | `${K}.5` | `${K}.6` | `${K}.7` | `${K}.8` | `${K}.9` | `${K}.10`]: string; }];
