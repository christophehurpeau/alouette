...
declare const _default: {
    title: string;
    component: import("@tamagui/web").TamaguiComponent<import("@tamagui/web").TamaDefer, unknown, import("@tamagui/web").TamaguiComponentPropsBaseBase & Omit<import("@tamagui/core").RNTamaguiViewNonStyleProps, "size" | "interactive" | "tint" | "center" | keyof import("@tamagui/web").StackStyleBase | "absoluteFill" | "layer" | "shadow" | "withBorder" | "withFocusVisibleOutline" | "withBackground"> & import("@tamagui/web").WithThemeValues<import("@tamagui/web").StackStyleBase> & {
...
export declare const PreviewGradientBackgroundStoryLightBrandLight: StoryObj;
export declare const PreviewGradientBackgroundStoryDarkBrand: StoryObj;
export declare const PreviewGradientBackgroundStoryDarkBrandLight: StoryObj;
