...
const themeVariables = reactNative.Platform.OS === "web" ? {} : {
  light: {
    ...
    "--color-interactive-contained-pressable": "#5D5D5D",
    "--color-interactive-contained-hover": "#6F6F6F",
    "--color-interactive-contained-focus": "#6F6F6F",
    "--color-interactive-contained-active": "#838383",
    "--color-interactive-list-pressable": "#FFFFFF",
    "--color-interactive-list-hover": "#F8F8F8",
    "--color-interactive-list-focus": "#F8F8F8",
    "--color-interactive-list-active": "#EEEEEE",
    "--color-interactive-soft-hover": "#EEEEEE",
    "--color-interactive-soft-focus": "#EEEEEE",
    "--color-interactive-soft-active": "#DBDBDB",
    ...
    "--color-on-accent-muted": "#DBDBDB",
    "--color-on-emphasis": "#262626",
    "--color-on-list": "#262626",
  ...
  dark: {
    ...
    "--color-interactive-list-pressable": "#484848",
    "--color-interactive-list-hover": "#555555",
    "--color-interactive-list-focus": "#555555",
    "--color-interactive-list-active": "#555555",
    "--color-interactive-soft-hover": "#3D3D3D",
    "--color-interactive-soft-focus": "#3D3D3D",
    "--color-interactive-soft-active": "#484848",
  ...
  light_brand: {
    ...
    "--color-interactive-list-pressable": "#EDF6FA",
    "--color-interactive-list-hover": "#E2F1F7",
    "--color-interactive-list-focus": "#E2F1F7",
    "--color-interactive-list-active": "#BDE2F1",
    "--color-interactive-soft-hover": "#E2F1F7",
    "--color-interactive-soft-focus": "#E2F1F7",
    "--color-interactive-soft-active": "#BDE2F1",
  ...
  light_info: {
    ...
    "--color-interactive-list-pressable": "#EFF6FA",
    "--color-interactive-list-hover": "#E4F0F7",
    "--color-interactive-list-focus": "#E4F0F7",
    "--color-interactive-list-active": "#C3E0F1",
    "--color-interactive-soft-hover": "#E4F0F7",
    "--color-interactive-soft-focus": "#E4F0F7",
    "--color-interactive-soft-active": "#C3E0F1",
  ...
  light_success: {
    ...
    "--color-interactive-list-pressable": "#E9FAE9",
    "--color-interactive-list-hover": "#DAF8D9",
    "--color-interactive-list-focus": "#DAF8D9",
    "--color-interactive-list-active": "#A2F2A4",
    "--color-interactive-soft-hover": "#DAF8D9",
    "--color-interactive-soft-focus": "#DAF8D9",
    "--color-interactive-soft-active": "#A2F2A4",
  ...
  light_warning: {
    ...
    "--color-interactive-list-pressable": "#FAF5E1",
    "--color-interactive-list-hover": "#F7EECE",
    "--color-interactive-list-focus": "#F7EECE",
    "--color-interactive-list-active": "#F5E7B7",
    "--color-interactive-soft-hover": "#F7EECE",
    "--color-interactive-soft-focus": "#F7EECE",
    "--color-interactive-soft-active": "#F5E7B7",
  ...
  light_danger: {
    ...
    "--color-interactive-list-hover": "#F7EAEA",
    "--color-interactive-list-focus": "#F7EAEA",
    "--color-interactive-list-active": "#F1D2D1",
    "--color-interactive-soft-hover": "#F7EAEA",
    "--color-interactive-soft-focus": "#F7EAEA",
    "--color-interactive-soft-active": "#F1D2D1",
  ...
  dark_brand: {
    ...
    "--color-interactive-list-pressable": "#184F61",
    "--color-interactive-list-hover": "#1F6D87",
    "--color-interactive-list-focus": "#1F6D87",
    "--color-interactive-list-active": "#1F6D87",
    "--color-interactive-soft-hover": "#163D4B",
    "--color-interactive-soft-focus": "#163D4B",
    "--color-interactive-soft-active": "#184F61",
  ...
  dark_info: {
    ...
    "--color-interactive-list-pressable": "#184E67",
    "--color-interactive-list-hover": "#1F6B8E",
    "--color-interactive-list-focus": "#1F6B8E",
    "--color-interactive-list-active": "#1F6B8E",
    "--color-interactive-soft-hover": "#163D50",
    "--color-interactive-soft-focus": "#163D50",
    "--color-interactive-soft-active": "#184E67",
  ...
  dark_success: {
    ...
    "--color-interactive-list-pressable": "#19561F",
    "--color-interactive-list-hover": "#1F772A",
    "--color-interactive-list-focus": "#1F772A",
    "--color-interactive-list-active": "#1F772A",
    "--color-interactive-soft-hover": "#16431A",
    "--color-interactive-soft-focus": "#16431A",
    "--color-interactive-soft-active": "#19561F",
  ...
  dark_warning: {
    ...
    "--color-interactive-list-pressable": "#846724",
    "--color-interactive-list-hover": "#8F7021",
    "--color-interactive-list-focus": "#8F7021",
    "--color-interactive-list-active": "#8F7021",
    "--color-interactive-soft-hover": "#785F28",
    "--color-interactive-soft-focus": "#785F28",
    "--color-interactive-soft-active": "#846724",
  ...
  dark_danger: {
    ...
    "--color-interactive-list-pressable": "#811C20",
    "--color-interactive-list-hover": "#B2242D",
    "--color-interactive-list-focus": "#B2242D",
    "--color-interactive-list-active": "#B2242D",
    "--color-interactive-soft-hover": "#64191A",
    "--color-interactive-soft-focus": "#64191A",
    "--color-interactive-soft-active": "#811C20",
...
//# sourceMappingURL=defaultThemeVariables-react-native.cjs.js.map
