...
const DesktopDuotoneIcon = require('alouette-icons/phosphor-icons/DesktopDuotoneIcon');
const DesktopRegularIcon = require('alouette-icons/phosphor-icons/DesktopRegularIcon');
const MoonDuotoneIcon = require('alouette-icons/phosphor-icons/MoonDuotoneIcon');
const MoonRegularIcon = require('alouette-icons/phosphor-icons/MoonRegularIcon');
const SunDuotoneIcon = require('alouette-icons/phosphor-icons/SunDuotoneIcon');
const SunRegularIcon = require('alouette-icons/phosphor-icons/SunRegularIcon');
...
function useSystemColorMode() {
  return reactNative.useColorScheme() === "dark" ? "dark" : "light";
}
...
function AccentScope({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ScopedTheme, { theme: accent === "neutral" ? mode : `${mode}_${accent}`, children });
}
...
function Story({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ScrollWrapper, { children: [
    ...
    ["light", ...noDarkMode ? [] : ["dark"]].map(
      (mode) => /* @__PURE__ */ jsxRuntime.jsx(ScopedTheme, { theme: mode, children: /* @__PURE__ */ jsxRuntime.jsx(ScrollView, { className: "h-full bg-screen px-l", children }) }, mode)
    )
  ] });
}
...
function StableAccentScope({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ScopedTheme, { theme, children });
}
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    View,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(View, { "aria-label": ariaLabel, className: "w-full", children })
      ]
    }
  );
}
function Popover({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    reactNative.Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(reactNativeSafeAreaContext.SafeAreaProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(PortalAccentScope, { accent, children: /* @__PURE__ */ jsxRuntime.jsx(
        PopoverOverlay,
        {
          placement,
          "aria-label": ariaLabel,
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(PortalAccentScope, { accent, children: /* @__PURE__ */ jsxRuntime.jsxs(View, { className: "flex-1 flex-center p-l", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          View,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(View, { className: styles.inset(), children: [
...
function AutocompleteMenu({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Surface, { variant: "highlight", shadow: "l", size: "sm", className: "p-xs pl-md", children: [
    visibleOptions.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(Text, { role: "status", className: "px-m py-xs text-base text-muted", children: emptyLabel }) : null,
    /* @__PURE__ */ jsxRuntime.jsx(View, { ref: menuRef, ...restMenuProps, children: /* @__PURE__ */ jsxRuntime.jsx(
      ScrollView,
      {
...
function InputTextAutocomplete({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(AccentScope, { accent, children: /* @__PURE__ */ jsxRuntime.jsx(
      InputText,
      {
        readOnly: true,
        role: "combobox",
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      Popover,
      {
        ...
        "aria-label": rest["aria-label"],
        onClose: closeMenu,
        children: /* @__PURE__ */ jsxRuntime.jsxs(View, { className: "gap-xs", children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            InputText,
            {
              ref: inputRef,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(AutocompleteMenu, { ...menu, emptyLabel })
        ] })
      }
    )
  ] });
...
const radioIndicatorVariants = tailwindVariants.tv({
  slots: {
...
function RadioButtonGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(RadioContextProvider, { value: context, children: /* @__PURE__ */ jsxRuntime.jsx(
    SegmentedBar,
    {
      role: "radiogroup",
      variant,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    InteractiveBox,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(View, { className: styles.segment(), children: [
        ...
        variant === "icon" ? null : /* @__PURE__ */ jsxRuntime.jsx(
          Text,
          {
            numberOfLines: 1,
        ...
        variant === "icon" && indicator ? /* @__PURE__ */ jsxRuntime.jsx(View, { className: styles.indicator(), children: /* @__PURE__ */ jsxRuntime.jsx(Icon, { icon: indicator, size: 10, className: styles.foreground() }) }) : null
      ] })
    }
  );
}
...
function ColorModeOption({
  ...
  if (mode === "dark") {
    return /* @__PURE__ */ jsxRuntime.jsx(
      RadioButton,
      {
        value: "dark",
        label,
        icon: /* @__PURE__ */ jsxRuntime.jsx(MoonRegularIcon.MoonRegularIcon, {}),
        activeIcon: /* @__PURE__ */ jsxRuntime.jsx(MoonDuotoneIcon.MoonDuotoneIcon, {}),
        indicator,
        onPress
      }
    );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    RadioButton,
    {
      value: "light",
      label,
      icon: /* @__PURE__ */ jsxRuntime.jsx(SunRegularIcon.SunRegularIcon, {}),
      activeIcon: /* @__PURE__ */ jsxRuntime.jsx(SunDuotoneIcon.SunDuotoneIcon, {}),
      indicator,
      onPress
    }
  );
...
function SystemColorModeOption({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    RadioButton,
    {
      value,
      label,
      icon: /* @__PURE__ */ jsxRuntime.jsx(DesktopRegularIcon.DesktopRegularIcon, {}),
      activeIcon: /* @__PURE__ */ jsxRuntime.jsx(DesktopDuotoneIcon.DesktopDuotoneIcon, {}),
      onPress
    }
  );
}
function ColorModeLockOption({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ColorModeOption,
    {
      ...
      indicator: followsSystem ? /* @__PURE__ */ jsxRuntime.jsx(DesktopRegularIcon.DesktopRegularIcon, {}) : void 0,
      onPress
    }
  );
}
...
const radioCardGroupVariants = tailwindVariants.tv({
  base: "gap-xs",
  variants: {
    variant: {
      list: "flex-col",
...
const RadioCardGroupVariantContext = react.createContext("list");
function useRadioCardGroupVariant() {
  return react.useContext(RadioCardGroupVariantContext);
}
function RadioCardGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AccentScope, { accent, children: /* @__PURE__ */ jsxRuntime.jsx(RadioContextProvider, { value: context, children: /* @__PURE__ */ jsxRuntime.jsx(RadioCardGroupVariantContext, { value: variant ?? "list", children: /* @__PURE__ */ jsxRuntime.jsx(
    View,
    {
      role: "radiogroup",
...
const radioCardVariants = tailwindVariants.tv(
  {
    slots: {
...
function RadioCard({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(DefaultAccentScope, { children: /* @__PURE__ */ jsxRuntime.jsxs(
    PressableBox,
    {
      ...
      children: [
        icon ? /* @__PURE__ */ jsxRuntime.jsx(Icon, { icon, size: 24, className: styles.icon() }) : null,
        /* @__PURE__ */ jsxRuntime.jsxs(VStack, { className: "flex-1 gap-xxs", children: [
          /* @__PURE__ */ jsxRuntime.jsx(Text, { className: styles.label(), children: label }),
          description ? /* @__PURE__ */ jsxRuntime.jsx(Text, { className: styles.description(), children: description }) : null
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(
          RadioIndicator,
          {
...
function Tabs({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TabsContextProvider, { value: context, children: /* @__PURE__ */ jsxRuntime.jsx(SegmentedBar, { role: "tablist", variant, accent, ...props, children }) });
}
...
function Form({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactHookForm.FormProvider, { ...form, children: render({ control: form.control, submit }) });
}
...
function FormField({
  ...
  const { setFocus } = reactHookForm.useFormContext();
  return /* @__PURE__ */ jsxRuntime.jsx(
...
function FormFieldArrayItem({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(StableAccentScope, { accent: pendingRemoval ? "danger" : void 0, children: /* @__PURE__ */ jsxRuntime.jsxs(HStack, { className: "gap-sm items-center p-xxs", children: [
    /* @__PURE__ */ jsxRuntime.jsx(View, { className: "grow shrink basis-0", children: render({ control, name, index, label: itemLabel }) }),
...
function SimpleVForm({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      ...formProps,
      render: ({ control, submit }) => /* @__PURE__ */ jsxRuntime.jsxs(VStack, { className: className ?? "gap-l", children: [
        ...
        render: ({ control, submit }) => /* @__PURE__ */ jsxRuntime.jsx(
          Modal,
          {
            ...
            footer: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(Button, { accent: "neutral", text: cancelLabel, onPress: close }),
              /* @__PURE__ */ jsxRuntime.jsx(
                FormSubmitButton,
                {
                  label: submitLabel,
...
function ConnectionState({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(AccentScope, { accent, children: /* @__PURE__ */ jsxRuntime.jsx(
    View,
    {
      ...
      children: state ? /* @__PURE__ */ jsxRuntime.jsx(Text, { className: "absolute left-1/2 top-0.5 h-5.5 w-50 -translate-x-1/2 rounded-b-sm bg-emphasis text-center leading-5.5 text-on-emphasis transition-colors duration-fast", children }) : null
    }
  ) });
}
...
exports.ColorModePicker = ColorModePicker;
...
exports.InputTextAutocomplete = InputTextAutocomplete;
...
exports.useSystemColorMode = useSystemColorMode;
