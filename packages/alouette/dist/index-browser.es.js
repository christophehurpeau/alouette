...
function GradientBackground({
  ...
  return /* @__PURE__ */ jsx(
    View$1,
    {
      ...
      style: {
        backgroundImage: `linear-gradient(0deg, ${end} 5%, ${middle} 80%, ${start} 98%)`
      },
      children
    }
  );
...
export { AlouetteDecorator, AlouetteProvider, Box, BreakpointNameEnum, Breakpoints, Button, ConfirmationMessage, ExternalLink, ExternalLinkButton, GradientBackground, GradientScrollView, HStack, Icon, IconButton, InfoMessage, InputText, InteractiveBox, InternalLinkButton, Message, Paragraph, PressableBox, PressableListItem, SafeAreaBox, SafeAreaProvider, ScrollView, SemanticScope, Separator, Stack, Story, StoryContainer, StoryDecorator, StoryGrid, StoryTitle, Surface, Switch, SwitchBreakpointsUsingDisplayNone, SwitchBreakpointsUsingNull, Text, TextArea, VStack, View, WarningMessage, styled, useCurrentBreakpointName, useCurrentBreakpointNameFiltered, useDefaultThemeFromColorScheme, useSafeAreaInsets };
